...
- (void)setModel:(SYJEmojiModel *)model{
    
    _model = model;
    [self.picImg sd_setImageWithURL:[NSURL URLWithString:model.img] placeholderImage:[UIImage imageNamed:@""]];
}
