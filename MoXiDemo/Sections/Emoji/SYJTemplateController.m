...
@interface SYJTemplateController ()<UICollectionViewDataSource,SYJCollectionFlowLayoutDelegate,UICollectionViewDelegate,SDPhotoBrowserDelegate>{
    int a;
...
@implementation SYJTemplateController
