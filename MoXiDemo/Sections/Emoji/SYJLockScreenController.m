...
@interface SYJLockScreenController ()<UICollectionViewDataSource,SYJCollectionFlowLayoutDelegate,UICollectionViewDelegate,SDPhotoBrowserDelegate>{
    int a;
...
@implementation SYJLockScreenController
