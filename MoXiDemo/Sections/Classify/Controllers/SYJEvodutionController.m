...
@interface SYJEvodutionController ()<UICollectionViewDataSource,SYJCollectionFlowLayoutDelegate,UICollectionViewDelegate,SDPhotoBrowserDelegate>{
    int a;
...
@implementation SYJEvodutionController
