...
@interface SYJLolitaController ()<UICollectionViewDataSource,SYJCollectionFlowLayoutDelegate,UICollectionViewDelegate,SDPhotoBrowserDelegate>{
    int a;
...
@implementation SYJLolitaController
